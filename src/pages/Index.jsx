  ...
  return (
    <Container centerContent maxW="container.md" height="100vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center">
      <VStack spacing={4}>
        ...
        <Text fontSize="md" textAlign="center" maxW="80%">
          Passionate about building scalable software solutions and interactive user experiences. Currently focused on React and modern JavaScript ecosystems.
        </Text>
        <VStack spacing={2}>
